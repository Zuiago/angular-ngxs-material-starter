...
export class FormsComponent extends UtilComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formulario = this.fb.group({
      ...
      emailTipo1: ['', [Validators.required, Validators.email]],
      emailTipo2: ['', [Validators.required, Validators.email]],
      cpf: this.fb.control(null, [Validators.required])
    });
  }

  getErrorMessage() {
    return this.formulario.controls['emailTipo2'].hasError('required')
      ? 'Você precisa inserir um valor'
